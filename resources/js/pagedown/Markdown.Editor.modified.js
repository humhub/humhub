        ...
        (function() {
            ...
            function UndoManager(callback, panels) {
                ...
                var refreshState = function(isInitialState) {
                    inputStateObj = new ContenteditableState(panels, isInitialState);
                    timer = undefined;
                };
                ...
                this.undo = function() {
                    ...
                    if(undoObj.canUndo()) {
                        if(lastState) {
                            ...
                            undoStack[stackPtr] = new ContenteditableState(panels);
                ...
                var saveState = function() {
                    var currState = inputStateObj || new ContenteditableState(panels);
                ...
                var setEventHandlers = function() {
                    ...
                    util.addEvent(panels.input, "focusout", function(event) {

                        var selection = window.getSelection();
                        $(panels.input).data('selection', {
                            start: {
            ...
            function ContenteditableState(panels, isInitialState) {
                ...
                this.setInputAreaSelectionStartEnd = function() {
                    console.log($(panels.input).data('selection'));
                    this.selection = $(panels.input).data('selection');
            ...
            function UIManager(postfix, panels, undoManager, previewManager, commandManager, helpOptions, getString) {
                ...
                function doClick(button) {
                    ...
                    if(button.textOp) {
                        ...
                        var state = new ContenteditableState(panels);
