...
<?php if ($type == "invite-space") : ?>


    <!-- START SPACE INVITE CONTENT -->
                                                ...
                                                <table border="0" cellspacing="0" cellpadding="0" align="center">
                                                    ...
                                                    <tr>
                                                        <td style="font-size: 14px; line-height: 22px; padding-left: 50px; padding-right: 50px; font-family:Open Sans,Arial,Tahoma, Helvetica, sans-serif; color:#777777; font-weight:300; text-align:center; ">
                                                            ...
                                                            at <?php echo Yii::app()->name; ?>
                                                            .<?php echo Yii::t('UserModule.views_mails_UserInviteSpace', '<br>A social network to increase your communication and teamwork.<br>Register now
...
<?php if ($type == "invite-self") : ?>

    <!-- START SELF INVITE CONTENT -->
    ...
    <!-- END SELF INVITE CONTENT -->

<?php endif; ?>



<?php if ($type == "change-email") : ?>


    <!-- START CHANGE EMAIL CONTENT -->
...
<?php if ($type == "recover-password") : ?>


    <!-- START RECOVER PASSWORD CONTENT -->
...
<?php if ($type == "text-only") : ?>

    <!-- START TEXT ONLY CONTENT -->
