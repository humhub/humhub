...
$config = [
    ...
    'bootstrap' => ['log', 'humhub\components\bootstrap\SettingsLoader', 'humhub\components\bootstrap\ModuleAutoLoader', 'queue', 'humhub\modules\ui\view\bootstrap\ThemeLoader'],
    'sourceLanguage' => 'en',
    'aliases' => [
