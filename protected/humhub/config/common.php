...
$config = [
    ...
    'bootstrap' => ['log', 'humhub\components\bootstrap\ModuleAutoLoader', 'humhub\components\bootstrap\SettingsLoader', 'queue', 'humhub\modules\ui\view\bootstrap\ThemeLoader'],
    'sourceLanguage' => 'en',
    'aliases' => [
