...
class StateServiceTest extends Unit
{
    ...
    public function testValidateStateInvalidArgument()
    {
        ...
        $errorMessage = 'Argument #1 $state passed to humhub\components\StateService::validateState must be of type iterable, array, Traversable if parameter #3 ($allowArray) is true. State configuration: [1,100] - array given.';
