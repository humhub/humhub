...
export const pageTitle = (...args) => vueModule().pageTitle(...args);
export const status = (...args) => vueModule().status(...args);
export const setStatusHandler = (...args) => vueModule().setStatusHandler(...args);
