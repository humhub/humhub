...
humhub.module('topic', function (module, require, $) {
    ...
    module.template = {
        'removeLabel': '<a href="#" class="topic-remove-label" data-action-click="topic.removeTopic" data-topic-id="{id}"><span class="label label-secondary animated bounceIn">{icon} {name}</span></a>'
    };
