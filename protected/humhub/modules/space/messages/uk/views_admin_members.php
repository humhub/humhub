 ...
 */
return [
    '<strong>Manage</strong> members' => '<strong>Керування</strong> учасниками',
    '<strong>Manage</strong> permissions' => '<strong>Управління</strong> правами доступу',
    '<strong>Pending</strong> approvals' => '<strong>Підтвердження</strong>',
    '<strong>Pending</strong> invitations' => '<strong>Запрошення</strong>',
