...
return [
    ...
    'Description, Name, Tags...' => 'Description, Nom, Étiquettes...',
    'Do you really want to delete the space image?' => 'Voulez-vous vraiment supprimer l\'image de l\'espace ?',
    'Do you really want to delete the space title image?' => 'Voulez-vous vraiment supprimer l\'image d\'en-tête de cet espace ?',
    ...
    'Leave' => 'Quitter',
    'Loading more spaces' => 'Chargement d\'autres espaces',
    ...
    'Show topic widget in Stream sidebar' => 'Afficher le widget « Sujets » dans la barre latérale du fil d\'actualités',
    ...
    'Space actions' => 'Actions de l\'espace',
    ...
    'View space image of {name}' => 'Voir l\'image de l\'espace de {name}',
    'Visibility' => 'Visibilité',
    'Visible for all (members and guests)' => 'Visible par tous (utilisateurs connectés et visiteurs)',
    'Warning: If you change the visibility settings of a Space from public to private, all content within that Space, including posts, comments, attachments etc. will also be set to private. This means that non-members will no longer be able to see, access, or interact with any of the content within that Space. Also all followers will be removed from this Space.' => 'Avertissement : si vous modifiez les paramètres de visibilité d\'un Espace pour le faire passer de « public » à « privé », tout le contenu de cet Espace, y compris les publications, les commentaires, les pièces jointes, etc., deviendra également privé. Cela signifie que les non-membres ne pourront plus voir, consulter ni interagir avec le contenu de cet Espace. De plus, tous les abonnés seront supprimés de cet Espace.',
    ...
    '{count} members' => '{count} membres',
    '{displayNames} joined the Space {spaceName}.' => '{displayNames} a rejoint l\'espace {spaceName}.',
    '{displayNames} joined this Space.' => '{displayNames} a rejoint cet espace.',
    '{displayNames} left the Space {spaceName}.' => '{displayNames} a quitté l\'espace {spaceName}.',
    '{displayNames} left this Space.' => '{displayNames} a quitté cet espace.',
    '{displayName} archived this Space.' => '{displayName} a archivé cet espace.',
    '{displayName} created the new Space {spaceName}.' => '{displayName} a créé le nouvel espace "{spaceName}".',
    '{displayName} created this Space.' => '{displayName} a créé cet espace.',
    '{displayName} has archived the Space {spaceName}.' => '{displayName} a archivé l\'espace "{spaceName}".',
    '{displayName} has unarchived the Space "{spaceName}".' => '{displayName} a désarchivé l\'espace "{spaceName}".',
    '{displayName} has unarchived this Space.' => '{displayName} a désarchivé cet espace.',
