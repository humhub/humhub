...
return array (
  ...
  '<strong>Request</strong> space membership' => '<strong>Ansök om</strong> medlemskap i forumet',
  ...
  'Please shortly introduce yourself, to become a approved member of this workspace.' => 'Vänligen presentera dig lite kort, för att bli godkänd som medlem i denna forumyta.',
  'Please shortly introduce yourself, to become an approved member of this space.' => 'Vänligen presentera dig lite kort, för att bli godkänd som medlem i detta forum.',
  'Posts' => 'Inlägg',
  'Private' => 'Privat',
  ...
  'Request workspace membership' => 'Begär medlemskap i forumytan',
  'Role' => 'Roll',
  'Search...' => 'Sök...',
  'See all' => 'Se alla',
  ...
  'Would you like to unfollow {userName}?' => 'Would you like to unfollow {userName}?',
  ...
  'You need to login to view contents of this space!' => 'Du behöver logga in för att visa innehållet i detta forum!',
  ...
  'Your request was successfully submitted to the workspace administrators.' => 'Din förfrågan skickades till administratörerna för forumytan.',
