...
return [
    ...
    'You were added to Space {spaceName}' => 'Du lades till nätverket {spaceName}',
    '{displayName} accepted your invite for the space {spaceName}' => '{displayName} accepterade din inbjudan till nätverket {spaceName}',
];
