...
return array (
  ...
  'Allows the user to invite new members to the space' => 'Разрешить пользователям приглашать других пользователей в пространство',
  ...
  'Create public content' => 'Создать публичный контент',
