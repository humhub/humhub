<?php
return array (
  '<strong>Space</strong> followers' => 'Участники <strong>сообщества</strong>',
  'Could not delete user who is a space owner! Name of Space: {spaceName}' => 'Нельзя удалить владельца сообщества. Сообщество: {spaceName}',
  ...
  'Public' => 'Публичное',
  'Public (Members & Guests)' => 'Открыто (Участники и Гости)',
