...
return [
    ...
    'Description, Name, Tags...' => 'Beschreibung, Name, Tags...',
    'Do you really want to delete the space image?' => 'Möchtest du das Space-Bild wirklich löschen?',
    'Do you really want to delete the space title image?' => 'Möchtest du das Titelbild des Spaces wirklich löschen?',
    ...
    'Leave' => 'Verlassen',
    'Loading more spaces' => 'Weitere Spaces werden geladen',
    ...
    'Show topic widget in Stream sidebar' => 'Themen-Widget in der Stream-Seitenleiste anzeigen',
    ...
    'View space image of {name}' => 'Space-Bild von {name} anzeigen',
    'Visibility' => 'Sichtbarkeit',
    'Visible for all (members and guests)' => 'Sichtbar für alle (auch ohne Benutzerkonto)',
    'Warning: If you change the visibility settings of a Space from public to private, all content within that Space, including posts, comments, attachments etc. will also be set to private. This means that non-members will no longer be able to see, access, or interact with any of the content within that Space. Also all followers will be removed from this Space.' => 'Warnung: Wenn du die Sichtbarkeitseinstellungen eines Spaces von öffentlich auf privat änderst, werden alle Inhalte innerhalb dieses Spaces, einschließlich Beiträge, Kommentare, Anhänge usw., ebenfalls auf privat gesetzt. Das bedeutet, dass Nicht-Mitglieder keine der Inhalte mehr sehen, darauf zugreifen oder damit interagieren können. Außerdem werden alle Follower aus diesem Space entfernt.',
    ...
    '{count} members' => '{count} Mitglieder',
    '{displayNames} joined the Space {spaceName}.' => '{displayNames} sind dem Space {spaceName} beigetreten.',
    '{displayNames} joined this Space.' => '{displayNames} sind diesem Space beigetreten.',
    '{displayNames} left the Space {spaceName}.' => '{displayNames} haben den Space {spaceName} verlassen.',
    '{displayNames} left this Space.' => '{displayNames} haben diesen Space verlassen.',
    '{displayName} archived this Space.' => '{displayName} hat diesen Space archiviert.',
    ...
    '{displayName} has archived the Space {spaceName}.' => '{displayName} hat den Space {spaceName} archiviert.',
    '{displayName} has unarchived the Space "{spaceName}".' => '{displayName} hat den Space "{spaceName}" wiederhergestellt.',
    '{displayName} has unarchived this Space.' => '{displayName} hat diesen Space wiederhergestellt.',
