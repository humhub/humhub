...
<div class="panel panel-default members" id="space-members-panel">
    ...
    <div class="panel-heading"><?= Yii::t('SpaceModule.widgets_views_spaceMembers', '<strong>Space</strong> members'); ?></div>
    <div class="panel-body">
        ...
        <?php if (count($users) == $maxMembers) : ?>
            <br>
            <a href="<?= $space->createUrl('/space/membership/members-list'); ?>" data-target="#globalModal" class="btn btn-default btn-sm">
                <?= Yii::t('SpaceModule.widgets_views_spaceMembers', 'Show all'); ?>
            </a>
        <?php endif; ?>
    </div>
</div>