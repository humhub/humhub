...
class Space extends ContentContainerActiveRecord implements Searchable
{
    ...
    public function rules()
    {
        $rules = [
            ...
            [['name'], 'required'],
            [['description', 'long_description', 'tags', 'color'], 'string'],
    ...
    public function scenarios()
    {
        ...
        $scenarios[static::SCENARIO_EDIT] = ['name', 'color', 'description', 'long_description', 'tags', 'join_policy', 'visibility', 'default_content_visibility', 'url'];
    ...
    public function attributeLabels()
    {
        return [
            ...
            'long_description' => Yii::t('SpaceModule.base', 'Long Description'),
