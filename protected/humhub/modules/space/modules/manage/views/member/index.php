                ...
                [
                    ...
                    'buttons' => [
                        ...
                        'delete' => function ($url, $model) use ($space) {
                            ...
                            return Html::a(Yii::t('SpaceModule.views_admin_members', 'Remove'), $space->createUrl('reject-applicant', ['userGuid' => $model->user->guid]), ['class' => 'btn btn-danger btn-sm', 'data-method' => 'POST', 'data-confirm' => Yii::t('SpaceModule.views_admin_members', 'Are you sure?')]);
                        },
                        'update' => function () {
                            return;
                        },
