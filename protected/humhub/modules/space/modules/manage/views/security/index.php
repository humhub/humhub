...
<div class="panel panel-default">
    ...
    <div class="panel-body">
        ...
        <?= $form->field($model, 'join_policy')->dropdownList($joinPolicies); ?>
        <p class="help-block"><?= Yii::t('SpaceModule.views_admin_edit', 'Choose the kind of membership you want to provide for this workspace.'); ?></p>
        <br>
        ...
        <p class="help-block"><?= Yii::t('SpaceModule.views_admin_edit', 'Choose the security level for this workspace to define the visibleness.'); ?></p>
        ...
        <?= $form->field($model, 'default_content_visibility')->dropdownList($contentVisibilities); ?>
        <p class="help-block"><?= Yii::t('SpaceModule.views_admin_edit', 'Choose if new content should be public or private by default'); ?></p>

        <?= Html::submitButton(Yii::t('base', 'Save'), array('class' => 'btn btn-primary', 'data-ui-loader' => '')); ?>
