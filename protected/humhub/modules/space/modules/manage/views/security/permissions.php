...
<div class="panel panel-default">
    ...
    <div class="panel-body">
        <p class="help-block"><?= Yii::t('SpaceModule.views_settings', 'Permissions are assigned to different user-roles. To edit a permission, select the user-role you want to edit and change the drop-down value of the given permission.'); ?></p>
    </div>
