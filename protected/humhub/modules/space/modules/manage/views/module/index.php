            ...
            <div class="media">
                ...
                <div class="media-body">
                    <h4 class="media-heading"><?= $module->getContentContainerName($space); ?>
                        <?php if ($space->moduleManager->isEnabled($moduleId)) : ?>
                    ...
                    <?php if ($space->moduleManager->canDisable($moduleId)) : ?>
                        <a href="#" style="<?= $space->moduleManager->isEnabled($moduleId) ? '' : 'display:none' ?>"
                    ...
                    <?php if ($module->getContentContainerConfigUrl($space) && $space->moduleManager->isEnabled($moduleId)) : ?>
