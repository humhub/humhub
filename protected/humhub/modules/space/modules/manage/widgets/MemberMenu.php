...
class MemberMenu extends \humhub\widgets\BaseMenu
{
    ...
    public function init()
    {
        ...
        $this->addItem(array(
            'label' => Yii::t('SpaceModule.widgets_views_spaceMembers','Members'),
        ...
        $this->addItem(array(
            'label' => Yii::t('SpaceModule.widgets_views_spaceMembers','Pending Invites'),
        ...
        $this->addItem(array(
            'label' => Yii::t('SpaceModule.widgets_views_spaceMembers','Pending Approvals'),
            'url' => $this->space->createUrl('/space/manage/member/pending-approvals'),
            'sortOrder' => 300,
            'isActive' => (Yii::$app->controller->action->id == 'pending-approvals'),
        ));
        $this->addItem(array(
            'label' => Yii::t('SpaceModule.widgets_views_spaceMembers','Permissions'),
        ...
        if ($this->space->isSpaceOwner()) {
            $this->addItem(array(
                'label' => Yii::t('SpaceModule.widgets_views_spaceMembers','Owner'),
