            ...
            <?php foreach ($applicants as $membership) : ?>
                ...
                <tr>
                    ...
                    <td align="left" valign="top">
                        ...
                        <hr>
                        <?php echo Html::a('Accept', $space->createUrl('/space/manage/member/approve-applicant', ['userGuid' => $user->guid]), ['data-method' => 'POST', 'class' => 'btn btn-success btn-sm']); ?>
                        <?php echo Html::a('Decline', $space->createUrl('/space/manage/member/reject-applicant', ['userGuid' => $user->guid]), ['data-method' => 'POST', 'class' => 'btn btn-danger btn-sm']); ?>
