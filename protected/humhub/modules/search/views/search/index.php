                    ...
                    <div class="row">
                        ...
                        <div class="col-md-6">
                            ...
                            <div class="form-group form-group-search">
                                <?= Html::textInput('keyword', $keyword, array('placeholder' => Yii::t('SearchModule.views_search_index', 'Search for user, spaces and content'), 'class' => 'form-control form-search', 'id' => 'search-input-field')); ?>
                            ...
                            <div class="text-center">
                                <a data-toggle="collapse" id="search-settings-link" href="#collapse-search-settings" style="font-size: 11px;">
                                    <i class="fa fa-caret-right"></i> <?= Yii::t('SearchModule.views_search_index', 'Advanced search settings'); ?>
                                </a>
                            </div>
                            ...
                            <div id="collapse-search-settings" class="panel-collapse collapse">
                                ...
                                <?= Html::textInput('limitSpaceGuids', $limitSpaceGuids, array('placeholder' => 'Specify space', 'style' => 'width:200px', 'id' => 'space_filter')); ?>
        ...
        <div class="row">
            <div class="col-md-2">
                <div class="panel panel-default">
                    <div class="panel-heading"><?= Yii::t('SearchModule.views_search_index', '<strong>Search </strong> results'); ?></div>
                    <div class="list-group">
                        <a href='<?= Url::to(['/search/search/index', 'keyword' => $keyword, 'limitSpaceGuids' => $limitSpaceGuids, 'scope' => SearchController::SCOPE_ALL]); ?>'
                           class="list-group-item <?php if ($scope == SearchController::SCOPE_ALL): ?>active<?php endif; ?>">
                            <div>
                                <div class="edit_group "><?= Yii::t('SearchModule.views_search_index', 'All'); ?>
                                    (<?= $totals[SearchController::SCOPE_ALL]; ?>)
                                </div>
                            </div>
                        </a>
                        <br>
                        <a href='<?= Url::to(['/search/search/index', 'keyword' => $keyword, 'limitSpaceGuids' => $limitSpaceGuids, 'scope' => SearchController::SCOPE_CONTENT]); ?>'
                           class="list-group-item <?php if ($scope == SearchController::SCOPE_CONTENT): ?>active<?php endif; ?>">
                            <div>
                                <div
                                    ...
                                    (<?= $totals[SearchController::SCOPE_CONTENT]; ?>)
                                </div>
                            </div>
                        </a>
                        <a href='<?= Url::to(['/search/search/index', 'keyword' => $keyword, 'limitSpaceGuids' => $limitSpaceGuids, 'scope' => SearchController::SCOPE_USER]); ?>'
                           class="list-group-item <?php if ($scope == SearchController::SCOPE_USER): ?>active<?php endif; ?>">
                            <div>
                                <div
                                    ...
                                    (<?= $totals[SearchController::SCOPE_USER]; ?>)
                                </div>
                            </div>
                        </a>
                        <a href='<?= Url::to(['/search/search/index', 'keyword' => $keyword, 'limitSpaceGuids' => $limitSpaceGuids, 'scope' => SearchController::SCOPE_SPACE]); ?>'
                           class="list-group-item <?php if ($scope == SearchController::SCOPE_SPACE): ?>active<?php endif; ?>">
                            <div>
                                <div
                                    ...
                                    (<?= $totals[SearchController::SCOPE_SPACE]; ?>)
                                </div>
                            </div>
                        </a>
                    </div>
            ...
            <div class="col-md-10">
                ...
                <div class="pagination-container"><?= \humhub\widgets\LinkPager::widget(['pagination' => $pagination]); ?></div>
                <br><br>
            </div>
