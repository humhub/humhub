...
return array (
  ...
  'LDAP' => 'LDAP',
  'LDAP Attribute for E-Mail Address. Default: &quotmail&quot;' => 'Atrybut LDAP dla adresów E-mail. Domyślny:  &amp;quotmail"',
  'LDAP Attribute for Username. Example: &quotuid&quot; or &quot;sAMAccountName&quot;' => 'Atrybut LDAP dla Nazwy Użytkownika. Przykład: &amp;quotuid" lub "sAMAccountName"',
  'Limit access to users meeting this criteria. Example: &quot(objectClass=posixAccount)&quot; or &quot;(&(objectClass=person)(memberOf=CN=Workers,CN=Users,DC=myDomain,DC=com))&quot;' => 'Ogranicz dostęp do użytkowników spełniających te kryteria. Przykład: &amp;quot(objectClass=posixAccount)" or "(&amp;(objectClass=osoba)(memberOf=CN=Pracownicy,CN=Users,DC=mojaDomena,DC=com))"',
