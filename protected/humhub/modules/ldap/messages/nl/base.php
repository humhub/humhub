<?php
return [
  'Allowed Authentication Methods' => 'Toegestane authenticatiemethoden',
  'Base DN' => 'Base DN',
  'Disable Certificate Checking' => 'Certificaatcontrole uitschakelen',
  ...
  'Password' => 'Wachtwoord',
  'Port' => 'Poort',
  'Select the authentication methods LDAP users may use. Unchecking "LDAP" disables direct LDAP password login and forces users through the other selected methods (e.g. SAML, OpenID Connect).' => 'Selecteer de authenticatiemethoden die LDAP-gebruikers mogen gebruiken. Door "LDAP" uit te schakelen, wordt direct inloggen met een LDAP-wachtwoord uitgeschakeld en worden gebruikers gedwongen de andere geselecteerde methoden te gebruiken (bijv. SAML, OpenID Connect).',
