...
return [
    ...
    'events' => [
        ...
        ['class' => CronController::class, 'event' => CronController::EVENT_ON_HOURLY_RUN, 'callback' => Events::onCronHourlyRun(...)],
        ...
        ['class' => SettingsMenu::class, 'event' => SettingsMenu::EVENT_INIT, 'callback' => Events::onSettingsMenuInit(...)],
        ['class' => Content::class, 'event' => Content::EVENT_AFTER_UPDATE, 'callback' => Events::onContentAfterUpdate(...)],
    ],
];
