...
return array (
  ...
  'E-Mail summaries are sent to inform you about recent activities in the network.' => 'E-postsammanfattningar skickas till dig för att informera dig om de senaste händelserna i nätverket.',
  'E-Mail summaries are sent to users to inform them about recent activities in your network.' => 'E-postsammanfattningar skickas till användare med de senaste händelserna i dina nätverk.',
  'Exclude spaces below from the mail summary' => 'Exkludera nedanstående nätverk från sammanfattningen',
  'Hourly' => 'Per timme',
  'Interval' => 'Intervall',
  ...
  'see online' => 'visa online',
  'via' => 'via',
  '{displayName} created the new space {spaceName}' => '{displayName} skapade det nya nätverket {spaceName}',
