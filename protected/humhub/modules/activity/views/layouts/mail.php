...
<tr>
    <td align="center" valign="top" class="fix-box">
        ...
        <table width="600" align="center" border="0" cellspacing="0" cellpadding="0" class="container"
               style="background-color: <?= MailStyle::getBackgroundColorMain() ?>; border-bottom-left-radius: 4px">
            <tr>
                <td valign="top">
                                                        ...
                                                        <table width="100%" border="0" cellspacing="0" cellpadding="0"
                                                            ...
                                                            <tr>
                                                                <td style="font-size: 13px; line-height: 22px; font-family: <?= MailStyle::getFontFamily() ?>; color:<?= MailStyle::getTextColorMain() ?>; font-weight:300; text-align:left; ">
                                                                    ...
                                                                    <div
                                                                        style="width:480px;overflow:hidden;text-overflow:ellipsis;font-size: 13px; line-height: 22px; font-family: <?= MailStyle::getFontFamily() ?>; color:<?= MailStyle::getTextColorMain() ?>; font-weight:300; text-align:left">
                                                                        <!-- content output-->
                                                                        <?= $content ?>
                                                                        ...
                                                                        <?php if ($space !== null): ?>
                                                                            <?= Html::a(
                                                                                ...
                                                                                [
                                                                                    'style' => 'text-decoration: none; color: ' . MailStyle::getTextColorMain(),
                                                                                ],
                                                                            ) ?>
                                                                        <?php endif ?>
                                                                        ...
                                                                        <?php if ($url != '') : ?>
                                                                            <!-- START: CONTENT LINK -->
                                                                            <span
                                                                                style="text-decoration: none; color: <?= MailStyle::getColorPrimary() ?>"> - <a
                                                                                    href="<?= $url ?>"
                                                                                    style="text-decoration: none; color: <?= MailStyle::getColorPrimary() ?>; font-weight: bold"><?= Yii::t('ActivityModule.base', 'see online') ?></a></span>
                                                                            <!-- END: CONTENT LINK -->
                                                                        <?php endif ?>
                                                                    </div>
