...
<div class="panel-body">
    ...
    <div class="help-block">
        ...
        <?= Yii::t('ActivityModule.base', 'On this page you can define the default behavior for your users. These settings can be overwritten by the users in their account settings page.'); ?>
        <br />
    </div>
    <br />
