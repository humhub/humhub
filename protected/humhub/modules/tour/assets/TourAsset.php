...
class TourAsset extends AssetBundle
{
    ...
    public static function register($view)
    {
        $view->registerJsConfig('tour', [
            ...
            'template' => '<div class="popover tour" role="tooltip"> <div class="arrow"></div> <h3 class="popover-title"></h3> <div class="popover-content"></div> <div class="popover-navigation"> <div class="btn-group"> <button class="btn btn-sm btn-outline-secondary" data-role="prev">' . Yii::t('TourModule.base', '« Prev') . '</button> <button class="btn btn-sm btn-outline-secondary" data-role="next">' . Yii::t('TourModule.base', 'Next »') . '</button> <button class="btn btn-sm btn-outline-secondary" data-role="pause-resume" data-pause-text="Pause" data-resume-text="Resume">Pause</button> </div> <button class="btn btn-sm btn-outline-secondary" data-role="end">' . Yii::t('TourModule.base', 'End guide') . '</button> </div> </div>'
        ]);
