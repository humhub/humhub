...
return array (
  ...
  '<strong>Start</strong> space guide' => '<strong>Starta</strong> nätverksguide',
  'Cancel' => 'Avbryt',
  ...
  'This is the most important menu and will probably be the one you use most often!<br><br>Access all the spaces you have joined and create new spaces here.<br><br>The next guide will show you how:' => 'Det här är den viktigaste menyn och den kommer förmodligen att vara den du använder oftast! <br><br> Besök alla nätverk du har gått med i och skapa nya utrymmen. <br><br> Nästa guide visar hur:',
