...
<div class="panel panel-default panel-tour" id="getting-started-panel">
    ...
    <div class="panel-body">
        ...
        <ul class="tour-list">
            ...
            <li class="<?php if ($spaces == 1) : ?>completed<?php endif; ?>"><a id="interface-tour-link" href="<?php echo Url::to(['/tour/tour/start-space-tour']); ?>"><i class="fa fa-play-circle-o"></i><?php echo Yii::t('TourModule.widgets_views_tourPanel', '<strong>Guide:</strong> Spaces'); ?></a></li>
