...
return array (
  ...
  'Url Prefix without http:// or https:// (e.g. youtube.com)' => 'プレフィックスUrlとは http:// or https:// を除いた文字列です (例： youtube.com)',
  ...
  'Use the default swipe to show sidebar on a mobile device' => 'モバイル端末ではサイドバーを表示するためにデフォルトのスワイプを使用する',
  'User' => 'ユーザー',
