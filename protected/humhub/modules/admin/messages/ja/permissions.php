...
return array (
  ...
  'Can manage spaces within the \'Administration -> Spaces\' section (create/edit/delete).' => '「管理メニュー → スペース」で、スペースの管理を許可します（作成・編集・削除）。',
  'Can manage user- space- and general-settings.' => 'ユーザー、スペース、一般設定の管理を許可します。',
