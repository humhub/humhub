...
return [
  ...
  'Install {phpExtension} Extension for Mercure push live driver' => 'Instale a extensão {phpExtension} para o driver Mercure push live.',
  ...
  'Please refer to the documentation to setup the cronjobs and queue workers.' => 'Consulte a documentação para configurar as tarefas crons e as filas de trabalho.',
  ...
  'Uploads' => 'Uploads',
  'Uploads - File' => 'Enviar - Arquivos',
  'Varying table engines are not supported.' => 'Os mecanismos de tabela variável não são suportados.',
  'Version' => 'Versão',
  'Waiting' => 'Aguardando',
  'Warning' => 'Atenção',
  'Web Application PHP version: `{webPhpVersion}`, Cron PHP Version: `{cronPhpVersion}`' => 'Versão do PHP da aplicação Web: `{webPhpVersion}`, Versão do PHP do Cron: `{cronPhpVersion}`',
  'Web Application and Cron uses the same PHP version' => 'A aplicação Web e o Cron usam a mesma versão do PHP',
  'Web Application and Cron uses the same user' => 'A aplicação Web e o Cron usam o mesmo usuário',
  'Web Application user: `{webUser}`, Cron user: `{cronUser}`' => 'Usuário da aplicação Web: `{webUser}`, Usuário Cron: `{cronUser}`',
