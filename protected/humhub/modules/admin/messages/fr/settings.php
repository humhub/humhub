...
return [
  ...
  'Allows posts to have an additional title shown above the content.' => 'Permet d\'afficher un titre supplémentaire au-dessus du contenu des articles.',
  ...
  'Invalid URL format: {url}' => 'Format d\'URL non valide : {url}',
  'Last visit' => 'Dernière visite',
  'Light color' => 'Couleur claire',
  'List of URLs that should be opened in the mobile in-app browser instead of the external one, and to be recognized as part of the HumHub ecosystem by the mobile app. Add * to the end of the URL to match all sub-paths. Example: https://example.com/*' => 'Liste des URL qui doivent s\'ouvrir dans le navigateur intégré à l\'application mobile plutôt que dans un navigateur externe, et qui doivent être reconnues par l\'application mobile comme faisant partie de l\'écosystème HumHub. Ajoutez * à la fin de l\'URL pour inclure tous les sous-chemins. Exemple : https://example.com/*',
  ...
  'Remove' => 'Enlever',
  'Replaced {mailService}' => 'Remplacé par {mailService}',
  'Required' => 'Requis',
  'Save' => 'Enregistrer',
  ...
  'Show topic widget in Dashboard sidebar' => 'Afficher le widget « Sujets » dans la barre latérale du tableau de bord',
  ...
  'URLs to whitelist' => 'URL à ajouter à la liste blanche',
  'Upload' => 'Déposer',
