...
return [
  ...
  'Allows posts to have an additional title shown above the content.' => 'Hiermee kan er een extra titel boven de inhoud van berichten worden weergegeven.',
  ...
  'Delete' => 'Verwijder',
  'Delete Topic' => 'Rubriek verwijderen',
  'Do you really want to delete this topic?' => 'Wilt u deze rubriek echt verwijderen?',
  'E-Mail' => 'E-mail',
  ...
  'Invalid URL format: {url}' => 'Ongeldig URL-formaat: {url}',
  'Last visit' => 'Laatste bezoek',
  'Light color' => 'Lichte kleur',
  'List of URLs that should be opened in the mobile in-app browser instead of the external one, and to be recognized as part of the HumHub ecosystem by the mobile app. Add * to the end of the URL to match all sub-paths. Example: https://example.com/*' => 'Lijst met URL\'s die in de mobiele app-browser moeten worden geopend in plaats van in een externe browser, en die door de mobiele app moeten worden herkend als onderdeel van het HumHub-ecosysteem. Voeg een * toe aan het einde van de URL om alle subpaden te matchen. Voorbeeld: https://example.com/*',
  ...
  'Show topic widget in Dashboard sidebar' => 'Toon de widget voor de rubrieken in de zijbalk van het Dashboard.',
  ...
  'URLs to whitelist' => 'URL\'s die op de whitelist moeten worden geplaatst',
  'Upload' => 'Upload',
