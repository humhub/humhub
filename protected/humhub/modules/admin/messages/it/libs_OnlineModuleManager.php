 ...
 */
return [
    'Could not fetch module list online! (%error%)' => '@@Non posso recuperare la lista dei moduli online! (%error%)@@',
    'Could not get module info online! (%error%)' => '@@Non posso prendere le informazioni sul modulo online! (%error%)@@',
    'Module directory for module %moduleId% already exists!' => '@@La directory del modulo %moduleId% già esiste!@@',
