...
return [
  ...
  'Allows posts to have an additional title shown above the content.' => 'Ermöglicht Beiträgen, einen zusätzlichen Titel oberhalb des Inhalts anzuzeigen.',
  ...
  'Invalid URL format: {url}' => 'Ungültiges URL-Format: {url}',
  'Last visit' => 'Letzter Zugriff',
  'Light color' => 'Helle Farbe',
  'List of URLs that should be opened in the mobile in-app browser instead of the external one, and to be recognized as part of the HumHub ecosystem by the mobile app. Add * to the end of the URL to match all sub-paths. Example: https://example.com/*' => 'Liste der URLs, die in der mobilen In-App-Browseransicht statt im externen Browser geöffnet und von der mobilen App als Teil des HumHub-Ökosystems erkannt werden sollen. Füge am Ende der URL ein * hinzu, um alle Unterpfade einzuschließen. Beispiel: https://example.com/*',
  ...
  'Remove' => 'Entfernen',
  'Replaced {mailService}' => '{mailService} ersetzt',
  ...
  'Show topic widget in Dashboard sidebar' => 'Themen-Widget in der Dashboard-Seitenleiste anzeigen',
  ...
  'URLs to whitelist' => 'Whitelist-URLs',
  'Upload' => 'Hochladen',
