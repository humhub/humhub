...
{AdminName} <br><br> ' => 'Hallo {displayName},<br /><br /> Deine Registrierungsanfrage wurde abgelehnt.<br /><br /> Mit freundlichen Grüßen<br /> {AdminName} <br /><br />',
  ...
  'Select which user information should be displayed in the \'People\' overview. You can select any profile fields, even those you have created individually. ' => 'Bestimme welche zusätzlichen Informationen über die Mitglieder im Benutzerverzeichnis angezeigt werden sollen. Du kannst frei aus allen Profilfeldern wählen, inbegriffen derer die du eigens angelegt hast.',
  ...
  'Will be used as a filter in \'People\'.' => 'Wird als Filter im Benutzerverzeichnis verwendet.',
  'Yes' => 'Ja',
