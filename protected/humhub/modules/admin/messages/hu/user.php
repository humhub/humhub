...
return array (
  ...
  '<strong>User</strong> administration' => '<strong>Felhasználó strong&gt; adminisztráció</strong>',
  ...
  'Groups' => 'Csoportok',
  'If this option is not selected, the ownership of the spaces will be transferred to your account.' => 'Ha ezt az opciót nem választod ki, akkor a közösségek tulajdonlása átkerül a fiókodba.',
  ...
  'Permanently delete' => 'Véglegesen törölje',
  ...
  'Using this option any contributions (e.g. contents, comments or likes) of this user will be irrevocably deleted.' => 'Ennek a opciónak a használatával visszavonhatatlanul törlődnek a felhasználó hozzájárulásai (például tartalmai, megjegyzései vagy kedvelései).',
