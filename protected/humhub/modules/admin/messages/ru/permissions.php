...
return [
  ...
  'Can manage (e.g. edit or delete) all content (even private)' => 'Может управлять (например, редактировать или удалять) всем контентом (даже приватным)',
  ...
  'Manage All Content' => 'Управлять всем контентом',
