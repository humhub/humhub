...
return [
  ...
  'Settings' => 'Настройки',
  'Show in Marketplace' => 'Посмотреть в Маркете',
  ...
  'This overview shows you all installed modules and allows you to enable, disable, configure and of course uninstall them. To discover new modules, take a look into our Marketplace. Please note that deactivating or uninstalling a module will result in the loss of any content that was created with that module.' => 'Этот раздел показывает все установленные модули и позволяет включать, выключать, настраивать и, конечно же, удалять их. Чтобы ознакомиться с новыми модулями, загляните в наш Маркет. Обратите внимание, что деактивация или удаление модуля приведёт к потере любого содержимого, созданного с помощью этого модуля.',
  'Topics' => 'Темы',
  'Uninstall' => 'Удалить',
  ...
  'Users' => 'Пользователи',
  'Version' => 'Версия',
  'Visit Marketplace' => 'Посетить Маркет',
