...
return [
  ...
  'E-Mail' => 'Email',
  'E-Mail reply-to' => 'Email reply-to',
  ...
  'File' => 'Файл',
  'Firstname Lastname (e.g. John Doe)' => 'Имя и Фамилия пользователя (например, Павел Бид)',
  ...
  'Save' => 'Сохранить',
  'Save & Flush Caches' => 'Сохранить и удалить кэш',
  ...
  'Show user profile post form on dashboard' => 'Показать блок для создания новых записей на домашней странице пользователя',
  'Sort by creation date' => 'Сортировка по дате создания',
  'Sort by update date' => 'Сортировка по дате обновления',
  'Test message' => 'Тестовое сообщение',
  'Theme' => 'Тема оформления',
  'These settings refer to advanced topics of your social network.' => 'Эта вкладка относятся к более глубоким настройкам вашего сайта.',
  'These settings refer to the appearance of your social network.' => 'Эта вкладка относятся к внешнему виду вашего сайта.',
