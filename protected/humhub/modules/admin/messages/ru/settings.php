...
return array (
  ...
  'Delete' => 'Удалить',
  'Display Name (Format)' => 'Формат отображения имён пользователей',
  ...
  'None - shows dropdown in user registration.' => 'Нет группы - показывать раскрывающемся меню при регистрации.',
