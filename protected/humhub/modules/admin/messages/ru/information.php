...
return [
  ...
  'Database collation' => 'Сортировки базы данных',
  ...
  'Different table collations in the tables: {tables}' => 'Различные варианты сортировки таблиц в таблицах: {tables}',
  ...
  'Marketplace API Connection' => 'Подключение к API Маркета',
  ...
  'Module Directory' => 'Каталог модуля',
  ...
  'Recommended collation is {collation}' => 'Рекомендуемая сортировка — {collation}',
  ...
  'Table collations' => 'Сортировки таблиц',
