...
return  [
  ...
  'Hello {displayName},<br><br>
   ...
   Kind Regards<br>
   {AdminName}<br><br>' => 'Dobrý den {displayName},<br><br> Váš účet byl aktivován.<br><br>Klikněte zde pro přihlášení:<br> <a href=\'{loginURL}\'>{loginURL}</a><br><br>S pozdravem<br> {AdminName}<br><br>',
  'Hello {displayName},<br><br>
