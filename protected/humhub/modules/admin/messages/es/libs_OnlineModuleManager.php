 ...
 */
return [
    'Could not fetch module list online! (%error%)' => '@@¡No se pudo obtener la lista de módulos en línea! (%error%)@@',
    'Could not get module info online! (%error%)' => '@@¡No se pudo obtener la información del módulo en línea! (%error%)@@',
    'Module directory for module %moduleId% already exists!' => '@@¡El directorio del módulo para el módulo %moduleId% ya existe!@@',
