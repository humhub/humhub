...
Kind Regards<br>
{AdminName}<br><br>' => 'Hello {displayName},<br><br> akun kamu sudah aktif<br><br> klik disini untuk masuk :<br> <a href=\'{loginURL}\'>{loginURL}</a><br><br> Salam Hormat<br> {AdminName}<br><br>',
  'Hello {displayName},<br><br>
