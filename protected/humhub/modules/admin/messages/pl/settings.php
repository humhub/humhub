...
return [
    ...
    '<strong>Warning:</strong> All users will be immediately logged out, except admins.' => '<strong>Ostrzeżenie:</strong> Wszyscy użytkownicy oprócz administratorów zostaną wylogowani.',
    'APC(u)' => 'APC(u)',
    'Activate' => 'Aktywuj',
    'Activate maintenance mode and disable access to the platform for non-admin users?<br><br>' => 'Aktywować tryb serwisowy i wyłączyć dostęp do platformy dla nieadministratorów?',
    ...
    'Deactivate maintenance mode and enable all users to access the platform again?' => 'Dezaktywować tryb serwisowy i zezwolić użytkownikom na dostęp do platformy?',
