...
<h4><?= Yii::t('AdminModule.views_category_product-index', 'Overview'); ?></h4>
<div class="help-block">
    <?= Yii::t('AdminModule.views_category_product-index', 'This overview contains the list of marketplace products categories with delete action.'); ?>
</div>
