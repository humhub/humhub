...
<div class="modal-dialog modal-dialog-normal animated fadeIn">
    <div class="modal-content">
        <div class="modal-header">
            ...
            <h4 class="modal-title" id="myModalLabel"><?= Yii::t('AdminModule.views_module_setAsDefault', '%moduleName% - Set as default module', array('%moduleName%' => "<strong>" . $module->getName() . "</strong>")); ?></h4>
        </div>
        
        <?php $form = humhub\compat\CActiveForm::begin(); ?>
        <div class="modal-body">
            <p><?= Yii::t('AdminModule.views_module_setAsDefault', 'Here you can choose whether or not a module should be automatically activated on a space or user profile. If the module should be activated, choose "always activated".'); ?></p>
            ...
            <div class="row">
                ...
                <?php if ($module->hasContentContainerType(Space::className())) : ?>
                    <div class="col-md-6">
                        ...
                        <div class="radio">
                            <label>
                                <?= $form->radioButton($model, 'spaceDefaultState', array(
                                    'value' => 0,
                                    'uncheckValue' => null,
                ...
                <?php if ($module->hasContentContainerType(User::className())) : ?>
                    <div class="col-md-6">
                        ...
                        <div class="radio">
                            <label>
                                <?= $form->radioButton($model, 'userDefaultState', array(
                                    'value' => 0,
                                    'uncheckValue' => null,
        ...
        <div class="modal-footer">
            ...
            ?>
            <button type="button" class="btn btn-primary" data-dismiss="modal"><?= Yii::t('AdminModule.views_module_setAsDefault', 'Close'); ?></button>

            <?= \humhub\widgets\LoaderWidget::widget(['id' => 'default-loader', 'cssClass' => 'loader-modal hidden']); ?>
