                ...
                <div class="media-body">
                    ...
                    <div class="module-controls">
                        ...
                        <?php if (isset($module['latestCompatibleVersion']) && Yii::$app->moduleManager->hasModule($module['id'])) : ?>
                            ...
                            &middot; <?= Html::a(Yii::t('AdminModule.views_module_listUpdates', 'Update'), ['update', 'moduleId' => $module['id']], array('style' => 'font-weight:bold', 'data-loader' => "modal", 'data-message' => Yii::t('AdminModule.views_module_listUpdates', 'Updating module...'), 'data-method' => 'POST')); ?>
