...
<div class="panel-body">
    ...
    <?= $form->field($model, 'logo')->fileInput(['id' => 'logo', 'style' => 'display: none', 'name' => 'logo[]']); ?>
    ...
    <div class="well">
        <div class="image-upload-container" id="logo-upload">
            ...
            <div class="image-upload-buttons" id="logo-upload-buttons" style="display: block;">
                <a href="#" onclick="javascript:$('#logo').click();" class="btn btn-info btn-sm"><i class="fa fa-cloud-upload"></i></a>
    ...
    <hr>
    <?= CHtml::submitButton(Yii::t('AdminModule.views_setting_design', 'Save'), array('class' => 'btn btn-primary', 'data-ui-loader' => "")); ?>
