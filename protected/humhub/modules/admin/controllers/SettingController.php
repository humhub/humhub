...
class SettingController extends Controller
{
    ...
    public function actionBasic()
    {
        ...
        foreach (\humhub\modules\space\models\Space::findAll([
        ...
        if ($form->load(Yii::$app->request->post()) && $form->validate()) {
            ...
            foreach ($spaceGuids as $spaceGuid) {
                $space = \humhub\modules\space\models\Space::findOne([
                    'guid' => $spaceGuid
                ]);
        ...
        return $this->render('basic', array(
            'model' => $form
        ));
    }
    ...
    public function actionAuthentication()
    {
        ...
        if ($form->load(Yii::$app->request->post()) && $form->validate()) {
            ...
            // ii::$app->response->redirect(Url::toRoute('/admin/setting/authentication'));
        }
        ...
        return $this->render('authentication', array(
            'model' => $form,
            'groups' => $groups
        ));
    }
    ...
    public function actionAuthenticationLdap()
    {
        ...
        return $this->render('authentication_ldap', array(
            'model' => $form,
            'enabled' => $enabled,
            'userCount' => $userCount,
    ...
    public function actionCaching()
    {
        ...
        return $this->render('caching', array(
            'model' => $form,
    ...
    public function actionStatistic()
    {
        ...
        return $this->render('statistic', array(
            'model' => $form
        ));
    }
    ...
    public function actionMailing()
    {
        ...
        return $this->render('mailing', array(
            'model' => $model
        ));
    }
    ...
    public function actionMailingServer()
    {
        ...
        return $this->render('mailing_server', array(
            'model' => $form,
    ...
    public function actionDesign()
    {
        ...
        return $this->render('design', array(
            'model' => $form,
            'themes' => $themes,
    ...
    public function actionSecurity()
    {
        ...
        return $this->render('security', array(
            'model' => $form
        ));
    }
    ...
    public function actionProxy()
    {
        ...
        return $this->render('proxy', array(
            'model' => $form
        ));
    }
    ...
    public function actionOembed()
    {
        ...
        return $this->render('oembed', array(
            'providers' => $providers
        ));
    }
    ...
    public function actionOembedEdit()
    {
        ...
        return $this->render('oembed_edit', array(
            'model' => $form,
            'prefix' => $prefix
        ));
    }
    ...
    {
        return $this->render('selftest', array(
