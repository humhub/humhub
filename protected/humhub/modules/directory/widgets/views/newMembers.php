...
<div class="panel panel-default members" id="new-people-panel">
    ...
    <?= \humhub\widgets\PanelMenu::widget(array('id' => 'new-people-panel')); ?>

    <div class="panel-heading">
        <?= Yii::t('DirectoryModule.widgets_views_memberStats', '<strong>New</strong> people'); ?>
    </div>
    <div class="panel-body">
        ...
        <?php if ($showMoreButton): ?>
            <?= Html::a('<i class="fa fa-list-ul" aria-hidden="true"></i>&nbsp;&nbsp;' . Yii::t('DirectoryModule.widgets_views_newMembers', 'See all'), Url::to(['/directory/directory/members']), array('classx' => 'btn btn-xl btn-primary', 'class' => 'pull-right')); ?>
        <?php endif; ?>
