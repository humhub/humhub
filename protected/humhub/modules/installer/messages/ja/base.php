...
return array (
  ...
  'On HumHub\'s side, you will need to edit the configuration file <code>{configFile}</code> and add the following block:' => 'HumHub側では、構成ファイル<code>{configFile}</code>を編集して、次のブロックを追加する必要があります。',
