...
return [
  ...
  '<strong>Pretty URLs</strong> configuration' => '<strong>Szép URL-ek</strong> konfigurációja',
  ...
  'On HumHub\'s side, you will need to edit the configuration file <code>{configFile}</code> and add the following block:' => 'A HumHub oldalán szerkesztenie kell a <code>{configFile}</code> konfigurációs fájlt, és hozzá kell adnia a következő blokkot:',
  ...
  'Our documentation provides a more detailed look into <a href="{link}" target="_blank">Pretty URLs</a>.' => 'Dokumentációnk részletesebb áttekintést nyújt a <a href="{link}">szép URL-ekről</a>.',
  'Password' => 'Jelszó',
  'Per default, the HumHub URL includes an <code>index.php</code> file in the address, resulting in a URL that looks like "<a>https://example.com/index.php?r=dashboard%2Fdashboard</a>" for example. By using the Pretty URL or URL Rewriting feature, it is possible to create shorter and easier to understand URLs, such as "<a>https://example.com/dashboard</a>".' => 'Alapértelmezés szerint a HumHub URL egy <code>index.php</code> fájlt tartalmaz a címben, ami a következő URL-t eredményezi: "<a>https://example.com/index.php?r=dashboard% 2Fdashboard</a>" például. A Pretty URL vagy URL Rewriting funkció használatával rövidebb és könnyebben érthető URL-ek hozhatók létre, például „<a>https://example.com/dashboard</a>”.',
  'Port' => 'Port',
