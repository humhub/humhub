...
return [
  ...
  'Could not send the test email.' => 'Impossible d\'envoyer l\'e-mail de test.',
  ...
  'E-Mail <strong>Delivery</strong>' => '<strong>Envoi</strong> d\'e-mail',
  'Ensure the following rule is present in your configuration: <strong>try_files $uri $uri/ /index.php$is_args$args;</strong>.' => 'Assurez-vous que la règle suivante est présente dans votre configuration : <strong>try_files $uri $uri/ /index.php$is_args$args;</strong>.',
  ...
  'Please enter an email address to send the test message to.' => 'Veuillez saisir une adresse e-mail à laquelle envoyer le message de test.',
  'Port' => 'Port',
  ...
  'Test' => 'Tester',
  'Test email successfully sent to: {address}' => 'E-mail de test envoyé avec succès à : {address}',
  ...
  'Working email delivery is required for account activation, invitations, notifications and password recovery. Configure it now, or keep the default and adjust it later in the administration.' => 'Working email delivery is required for account activation, invitations, notifications and password recovery. Configure it now, or keep the default and adjust it later in the administration.',
  ...
  'You entered a test recipient but haven’t sent a test email yet. Send the test email now instead of continuing?' => 'Vous avez saisi un destinataire pour le test, mais vous n\'avez pas encore envoyé d\'e-mail de test. Voulez-vous envoyer l\'e-mail de test maintenant plutôt que de continuer ?',
