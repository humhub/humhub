...
return [
  ...
  '<strong>Apache</strong> web server detected.' => '<strong>Apache</strong>-Webserver erkannt.',
  ...
  '<strong>Nginx</strong> web server detected.' => '<strong>Nginx</strong>-Webserver erkannt.',
  ...
  'Could not send the test email.' => 'Die Test-E-Mail konnte nicht gesendet werden.',
  ...
  'E-Mail <strong>Delivery</strong>' => 'E-Mail-<strong>Zustellung</strong>',
  'Ensure the following rule is present in your configuration: <strong>try_files $uri $uri/ /index.php$is_args$args;</strong>.' => 'Stelle sicher, dass die folgende Regel in deiner Konfiguration vorhanden ist: <strong>try_files $uri $uri/ /index.php$is_args$args;</strong>.',
  ...
  'Password' => 'Passwort',
  'Please enter an email address to send the test message to.' => 'Bitte gib eine E-Mail-Adresse ein, an die die Testnachricht gesendet werden soll.',
  'Port' => 'Port',
  'Pretty URLs may not work correctly.' => 'Pretty URLs funktionieren möglicherweise nicht korrekt.',
  'Pretty URLs should work correctly.' => 'Pretty URLs sollten korrekt funktionieren.',
  ...
  'Test' => 'Testen',
  'Test email successfully sent to: {address}' => 'Test-E-Mail erfolgreich gesendet an: {address}',
  'Test message' => 'Testnachricht',
  'The <strong>.htaccess</strong> file is in place.' => 'Die <strong>.htaccess</strong>-Datei ist vorhanden.',
  'The <strong>.htaccess</strong> file is not in place. In the installation folder, locate the <strong>.htaccess.dist</strong> file and rename it to <strong>.htaccess</strong>.' => 'Die <strong>.htaccess</strong>-Datei ist nicht vorhanden. Suche im Installationsordner die Datei <strong>.htaccess.dist</strong> und benenne sie in <strong>.htaccess</strong> um.',
  'The <strong>mod_rewrite</strong> module is active.' => 'Das <strong>mod_rewrite</strong>-Modul ist aktiv.',
  'The <strong>mod_rewrite</strong> module is not enabled.' => 'Das <strong>mod_rewrite</strong>-Modul ist nicht aktiviert.',
  ...
  'Unable to automatically detect your web server type. Please ensure URL rewriting is configured.' => 'Der Typ deines Webservers konnte nicht automatisch erkannt werden. Bitte stelle sicher, dass URL-Rewriting konfiguriert ist.',
  ...
  'Working email delivery is required for account activation, invitations, notifications and password recovery. Configure it now, or keep the default and adjust it later in the administration.' => 'Eine funktionierende E-Mail-Zustellung ist für die Kontoaktivierung, Einladungen, Benachrichtigungen und die Passwortwiederherstellung erforderlich. Konfiguriere sie jetzt oder behalte die Standardeinstellungen bei und passe sie später in der Administration an.',
  ...
  'You entered a test recipient but haven’t sent a test email yet. Send the test email now instead of continuing?' => 'Du hast einen Testempfänger eingegeben, aber noch keine Test-E-Mail gesendet. Soll die Test-E-Mail jetzt gesendet werden, anstatt fortzufahren?',
