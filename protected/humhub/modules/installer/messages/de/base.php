...
Deinem Sozialen Netzwerk.',
  ...
  'On HumHub\'s side, you will need to edit the configuration file <code>{configFile}</code> and add the following block:' => 'Auf der Seite von HumHub muss die Konfigurationsdatei <code>{configFile}</code> bearbeitet und der folgende Block hinzufügt werden:',
  ...
  'Our documentation provides a more detailed look into <a href="{link}" target="_blank">Pretty URLs</a>.' => 'Unsere Dokumentation bietet einen detaillierteren Einblick in <a href="{link}">Pretty URLs</a>.',
  'Password' => 'Passwort',
  'Per default, the HumHub URL includes an <code>index.php</code> file in the address, resulting in a URL that looks like "<a>https://example.com/index.php?r=dashboard%2Fdashboard</a>" for example. By using the Pretty URL or URL Rewriting feature, it is possible to create shorter and easier to understand URLs, such as "<a>https://example.com/dashboard</a>".' => 'In der Grundkonfiguration enthalten HumHUb URLs eine <code>index.php</code> Datei, was zu einer URL wie beispielsweise "<a>https://example.com/index.php?r=dashboard%2Fdashboard</a>" führt. Durch die Verwendung der Pretty URL- bzw. der URL Rewriting-Funktion ist es möglich, kürzere und leichter verständliche URLs zu generieren, z. B. "<a>https://example.com/dashboard</a>".',
  'Port' => 'Port',
