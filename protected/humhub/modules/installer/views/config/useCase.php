...
<div id="name-form" class="panel panel-default animated fadeIn">
    ...
    <div class="panel-heading">
        <?= Yii::t('InstallerModule.views_config_useCase', '<strong>Configuration</strong>'); ?>
    </div>

    <div class="panel-body">

        <p><?= Yii::t('InstallerModule.views_config_useCase', 'To simplify the configuration, we have predefined setups for the most common use cases with different options for modules and settings. You can adjust them during the next step.'); ?></p>
        <br>
