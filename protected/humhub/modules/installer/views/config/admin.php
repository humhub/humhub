<div id="create-admin-account-form" class="panel panel-default animated fadeIn">
    ...
    <div class="panel-heading">
        <?= Yii::t('InstallerModule.views_config_admin', '<strong>Admin</strong> Account'); ?>
    </div>

    <div class="panel-body">
        <p><?= Yii::t('InstallerModule.views_config_admin', "You're almost done. In this step you have to fill out the form to create an admin account. With this account you can manage the whole network."); ?></p>
        <hr>
