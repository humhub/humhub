...
return array (
  ...
  'There are new updates available at {baseUrl}' => 'Il y a de nouvelles actualités sur {baseUrl}',
  'There are new updates available at {baseUrl} - ({category})' => 'Il y a de nouvelles actualités sur {baseUrl} - ({category})',
  'This view allows you to configure your notification settings by selecting the desired targets for the given notification categories.' => 'Cet affichage vous permet de configurer vos notifications en sélectionnant le canal préféré pour chaque catégorie de notifications.',
