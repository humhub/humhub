...
class RichTextEmailHtmlConverterTest extends HumHubDbTestCase
{
    ...
    public function testConvertImageToHtml()
    {
        ...
        $this->assertConversionResult(
            ...
            '<p>Test<img src="http://localhost:8080/index-test.php?r=file%2Ffile%2Fdownload&amp;guid=' . $file->guid . '&amp;hash_sha1=&amp;token=' . $token . '" alt="test_image.jpg" style="max-width: 100%;">Test</p>', [
