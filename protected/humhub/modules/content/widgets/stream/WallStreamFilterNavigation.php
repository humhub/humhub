...
use humhub\modules\content\models\stream\filters\ContentTypeStreamFilter;
use humhub\modules\content\models\stream\filters\DateStreamFilter;
use humhub\modules\content\models\stream\filters\DefaultStreamFilter;
use humhub\modules\content\models\stream\filters\TopicStreamFilter;
use humhub\modules\topic\widgets\TopicPicker;
use humhub\widgets\filter\DatePickerFilterInput;
use humhub\widgets\filter\FilterNavigation;
...
class WallStreamFilterNavigation extends FilterNavigation
{
     ...
     * @var string view
     */
    public $view = '@content/widgets/stream/views/wallStreamFilterNavigation';
    ...
    protected function initFilterBlocks()
    {
        ...
        if (TopicPicker::showTopicPicker(ContentContainerHelper::getCurrent())) {
            $this->addFilterBlock(static::FILTER_BLOCK_TOPIC, [
                'title' => Yii::t('ContentModule.filter', 'Topic'),
                'sortOrder' => 300,
            ], static::PANEL_COLUMN_3);
        }
    }
    ...
    protected function initSortFilters()
    {
        ...
        $defaultSorting = $contentContainerDefaultSort ?: Yii::$app->getModule('content')->settings->get('defaultStreamSort', Stream::SORT_CREATED_AT);
