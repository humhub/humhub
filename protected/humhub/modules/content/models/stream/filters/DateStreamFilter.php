...
namespace humhub\modules\content\models\stream\filters;
 ...
 * @package humhub\modules\content\models\stream\filters
 *
...
class DateStreamFilter extends StreamQueryFilter
{
    ...
    public function validateDateFrom()
    {
        if ($this->isFilteredFrom() && $this->isFilteredTo() && $this->dateFrom > $this->dateTo) {
            $this->addError(self::CATEGORY_FROM, Yii::t('ContentModule.base', 'Date "From" should be before "To"!'));
        }
    }
