...
humhub.module('content', function (module, require, $) {
    ...
    var templates = {
        permalinkBody: '<div class="clearfix"><textarea rows="3" class="form-control permalink-txt" spellcheck="false" readonly>{permalink}</textarea><p class="text-body-secondary float-end"><a href="#" data-action-click="copyToClipboard" data-action-target=".permalink-txt"><i class="ti ti-clipboard" aria-hidden="true"></i> {info}</a></p></div>',
