...
return [
    '(Also visible to non-members of this space)' => '(Även synligt för personer som inte är medlemmar i detta nätverk)',
    ...
    'Invalid space selection.' => 'Felaktigt valt nätverk.',
    ...
    'The author of this content is not allowed to create private content within the selected space.' => 'Ägaren till detta innehåll har inte tillåtelse att skapa privat innehåll inom det valda nätverket.',
    'The author of this content is not allowed to create public content within the selected space.' => 'Ägaren till detta innehåll har inte tillåtelse att skapa publikt innehåll inom det valda nätverket.',
    'The author of this content is not allowed to create this type of content within this space.' => 'Ägaren till detta innehåll har inte tillåtelse att skapa den här typen av innehåll inom det här nätverket.',
    ...
    'The module {moduleName} is not enabled on the selected target space.' => 'Modulen {moduleName} är inte aktiverad i det valda nätverket.',
    ...
    'This space is not visible!' => 'Nätverket är inte synligt!',
    'Topics' => 'Ämnen',
    ...
    'Visible to all Space members' => 'Synlig för alla nätverksmedlemmar',
    ...
    'Where I\'m involved' => 'Där jag är inblandad',
    'With file attachments' => 'Med filer som bilagor',
