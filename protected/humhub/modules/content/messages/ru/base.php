...
return [
  ...
  'Maximum number of pinned items reached!<br>You can only pin up to {count} items at once.' => 'Уже закреплено максимальное количество записей!<br>Одновременно можно закрепить не более {count, plural, =0{# записей} one{# записи} few{# записей} other{# записей}}',
