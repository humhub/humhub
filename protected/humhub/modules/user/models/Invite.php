...
class Invite extends ActiveRecord
{
    ...
    {
        // Ensure Yii::$app is available when setting properties
        $this->skipCaptchaValidation = Yii::$app->params['skipCaptchaValidation'] ?? null;
    ...
    {
        return !$this->skipCaptchaValidation && (Yii::$app->getModule('user')->settings->get('auth.showCaptureInRegisterForm'));
    }
}
