...
/**
 * Description of GroupPermissionManager
 *
 * @author luke
 */
class GroupPermissionManager extends AbstractPermissionManager
{
    /**
     ...
     * @return boolean
     */
    protected function verify(\humhub\components\permission\BasePermission $permission)
    {
