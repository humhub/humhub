                                            ...
                                            <table border="0" align="center" cellpadding="0" cellspacing="0">
                                                <tr>
                                                    <td width="auto" align="center" valign="middle" height="32"
                                                        style=" background-color:<?= MailStyle::getColorPrimary() ?>; border-radius:5px; background-clip: padding-box;font-size:14px; font-family: <?= MailStyle::getFontFamily() ?>; text-align:center;  color:<?= MailStyle::getTextColorContrast() ?>; font-weight: 600; padding: 5px 30px">
