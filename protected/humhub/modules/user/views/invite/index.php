    ...
    <div class="modal-body">
        ...
        <ul class="nav nav-tabs">
            <li class="nav-item active">
                <a class="nav-link" data-toggle="tab" href="#invite-by-email"><?= Yii::t('UserModule.base', 'Invite by email') ?></a>
            </li>
            <li class="nav-item">
                <a class="nav-link" data-toggle="tab" href="#invite-by-link"><?= Yii::t('UserModule.base', 'Invite by link') ?></a>
            </li>
        </ul>
        <?php endif; ?>
        ...
        <div class="tab-content">
            ...
            <div class="tab-pane<?= $canInviteByEmail ? '' : ' active' ?>" id="invite-by-link">
                <br/>
                <strong><?= Yii::t('UserModule.invite', 'Please share this secure link to the people you want to invite.') ?></strong>
                <br/><br/>
                ...
                <?php if (Yii::$app->user->can([ManageUsers::class, ManageGroups::class])) : ?>
                    <?= ModalButton::danger(Yii::t('UserModule.base', 'Create a new secure link'))
                        ->confirm(null, Yii::t('UserModule.base', 'The previous link will not work anymore!'))
                        ->icon('refresh')
                        ->load(['/user/invite/reset-invite-link', 'adminIsAlwaysAllowed' => $adminIsAlwaysAllowed])
                    ?>
                <?php endif; ?>
            </div>
            <?php endif; ?>
