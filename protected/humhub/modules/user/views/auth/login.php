            ...
            <div class="row">
                ...
                <div class="col-md-8 text-right">
                    <small>
                        ...
                        <a href="<?= Url::toRoute('/user/password-recovery'); ?>"><br><?= Yii::t('UserModule.views_auth_login', 'Create a new one.') ?></a>
                    </small>
                </div>
            </div>
    ...
    <?php if ($canRegister) : ?>
        <div id="register-form"
            ...
            <div class="panel-body">
                ...
                <hr>
                <?= CHtml::submitButton(Yii::t('UserModule.views_auth_login', 'Register'), array('class' => 'btn btn-primary', 'data-ui-loader' => '')); ?>
