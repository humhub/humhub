...
return [
  ...
  'Connect {provider} account' => 'Connecter le compte {provider}',
  ...
  'Disconnect {provider} account' => 'Déconnecter le compte {provider}',
  'Edit' => 'Modifier',
  'Email' => 'e-mail',
  ...
  'Loading more people' => 'Chargement de plus de personnes',
  'Local' => 'Local',
  ...
  'This login method is not allowed for your account.' => 'Cette méthode de connexion n\'est pas autorisée pour votre compte.',
  ...
  'View profile image of {name}' => 'Voir la photo de profil de {name}',
