...
return array (
  ...
  'Here you can manage your account permissions for different user-types. To edit a permission, select the user-type you want to edit and change the drop-down value of the given permission.' => 'Ici vous pouvez gérer les permissions pour différent types d\'utilisateur. Pour modifier une permission, choisissez le type d\'utilisateur que vous désirez modifier et faites un choix dans le menu déroulant.',
