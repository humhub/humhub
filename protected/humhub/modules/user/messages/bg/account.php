...
return array (
  ...
  '<strong>Security</strong> settings' => '<strong>Настройки</strong> за сигурност',
  ...
  'Here you can manage your account permissions for different user-types. To edit a permission, select the user-type you want to edit and change the drop-down value of the given permission.' => 'Тук можете да управлявате разрешенията за вашия акаунт за различни типове потребители. За да редактирате разрешение, изберете типа потребител, който искате да редактирате, и променете падащата стойност на даденото разрешение.',
