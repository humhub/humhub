...
return array (
  ...
  '<strong>User</strong> Account' => '<strong>ユーザー</strong> アカウント',
  ...
  'Define basic settings for your profile. You can add tags that fit you, choose the language and your time zone and block impolite users.' => 'プロファイルの基本設定を定義します。自分に合ったタグを追加し、言語とタイム ゾーンを選択し、失礼なユーザーをブロックできます。',
