...
return array (
  ...
  'E-Mail is already in use! Try to sign in.' => 'メールは既に使用されています！サインインしてみて下さい。',
  'Email' => 'メール',
  ...
  'Missing ID AuthClient Attribute from AuthClient.' => 'AuthClient からの ID AuthClient 属性がありません。',
  'Modules' => 'モジュール',
  'My Account' => 'アカウント',
  'Name' => '名前',
  ...
  'Your are already logged in! - Logout first!' => 'あなたは既にログインしています！ - まずログアウトして下さい',
