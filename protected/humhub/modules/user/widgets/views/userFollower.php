            ...
            <?php foreach ($followers as $follower): ?>
                <a href="<?php echo $follower->getUrl(); ?>">
                    <img src="<?php echo $follower->getProfileImage()->getUrl(); ?>" class="img-rounded tt img_margin"
                         ...
                         data-original-title="<strong><?php echo Html::encode($follower->displayName); ?></strong><br><?php echo Html::encode($follower->profile->title); ?>">
                </a>
            <?php endforeach; ?>
        </div>
    </div>
            ...
            <?php foreach ($following as $followingUser): ?>
                <a href="<?php echo $followingUser->getUrl(); ?>">
                    <img src="<?php echo $followingUser->getProfileImage()->getUrl(); ?>" class="img-rounded tt img_margin"
                         ...
                         style="width: 24px; height: 24px;"
                         data-toggle="tooltip" data-placement="top" title=""
                         data-original-title="<strong><?php echo Html::encode($followingUser->displayName); ?></strong><br><?php echo Html::encode($followingUser->profile->title); ?>">
                </a>
            <?php endforeach; ?>
        </div>
    </div>
