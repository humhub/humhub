...
<?php if (count($followers) > 0): ?>
    <div class="card card-default follower" id="profile-follower-panel">

        <!-- Display panel menu widget -->
        <?php echo \humhub\widgets\PanelMenu::widget(['id' => 'profile-follower-panel']); ?>

        <div class="card-header"><?php echo Yii::t('UserModule.base', '<strong>Followers</strong>'); ?></div>
...
<?php if (count($following) > 0): ?>
    <div class="card card-default follower" id="profile-following-panel">
        <!-- Display panel menu widget -->
