...
<?php if (Yii::$app->user->isGuest): ?>
    <a href="<?php echo Url::toRoute('/user/auth/login'); ?>" class="btn btn-enter" data-target="#globalModal"><?php echo Yii::t('UserModule.widgets_views_accountTopMenu', 'Sign in / up'); ?></a>
<?php else: ?>
    <ul class="nav">
