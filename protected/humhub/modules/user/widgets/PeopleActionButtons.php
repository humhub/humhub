...
class PeopleActionButtons extends Widget
{
    ...
    protected function addFriendshipButton(): string
    {
        return FriendshipButton::widget([
            'user' => $this->user,
            'options' => [
                'friends' => ['attrs' => ['class' => 'btn btn-accent btn-sm active']],
                'addFriend' => ['attrs' => ['class' => 'btn btn-accent btn-sm']],
                'acceptFriendRequest' => ['attrs' => ['class' => 'btn btn-accent btn-sm active'], 'togglerClass' => 'btn btn-accent btn-sm active'],
                'cancelFriendRequest' => ['attrs' => ['class' => 'btn btn-accent btn-sm active']],
            ],
        ]);
    }
