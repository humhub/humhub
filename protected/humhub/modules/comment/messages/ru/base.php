...
return array (
  ...
  'Show next {count} comments' => 'Показать следующие {count, plural, =0{# комментариев} one{# комментарий} few{# комментария} other{# комментариев}}',
  'Show previous {count} comments' => 'Показать предыдущие {count, plural, =0{# комментариев} one{# комментарий} few{# комментария} other{# комментариев}}',
  'Show' => 'Показать',
