...
{displayNames} han comentat {contentTitle}.
',
  '{displayNames} just commented your {contentTitle}' => '
{displayNames} acaben de comentar el teu {contentTitle}
',
  '{displayNames} just commented your {contentTitle} in space {space}' => '
{displayNames} acaben de comentar el teu {contentTitle} en l\'espai {space}
',
  '{displayName} commented {contentTitle}' => '
{displayName} ha comentat {contentTitle}
',
