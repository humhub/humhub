...
class Comment extends ContentAddonActiveRecord
{
    ...
    public static function GetCommentsLimited($model, $id, $limit = 2)
    {
        ...
        if ($comments === false) {
            ...
            $comments = $query->all();
            Yii::$app->cache->set($cacheID, $comments, \humhub\models\Setting::Get('cache.expireTime'));
        }
    ...
    public static function GetCommentCount($model, $id)
    {
        ...
        if ($commentCount === false) {
            ...
            Yii::$app->cache->set($cacheID, $commentCount, \humhub\models\Setting::Get('cache.expireTime'));
        }
