...
{
    /**
     * Placeholder every id in the rendered markup is built from. The client replaces every
     * occurrence with a unique per-instance id before mounting a clone of this shell - see
     * `LegacyFormWrapper.vue`'s class docblock for the full token contract (ids declared via
     * `id`/`for` as well as CSS-id-selector fragments embedded in `data-upload-*` attributes).
     */
