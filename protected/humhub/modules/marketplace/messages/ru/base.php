...
' => 'Неверный лицензионный ключ модуля!',
  ...
  'Module <strong>activated</strong>' => 'Модуль <strong>активирован</strong>',
...
' => 'Модуль не найден!',
  ...
  'Well done! To make the module available within your network, you will also need to activate it. Do you want to activate it now?' => 'Отличная работа! Чтобы сделать модуль доступным в вашей сети, вам также необходимо его активировать. Хотите активировать его сейчас?',
  'Well done! You have successful installed an activated the module!' => 'Отличная работа! Вы успешно установили и активировали модуль!',
