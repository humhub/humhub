...
' => 'La licence a été supprimée avec succès !',
  ...
  'Buy unverified community module?' => 'Acheter un module communautaire non vérifié ?',
  'Cancel' => 'Annuler',
  'Categories' => 'Catégories',
  'Changelog' => 'Journal des modifications',
  'Community' => 'Communauté',
  'Community modules are developed by third parties and are <strong>not tested or maintained by the HumHub team</strong>.<br><br>They may not be compatible with your HumHub version, can cause <strong>instability or unexpected behavior</strong>, and may stop working after future updates. Their long-term maintenance is not guaranteed.<br><br>Only enable this option if you understand the risks and trust the source of the module you intend to install.' => 'Les modules communautaires sont développés par des tiers et ne sont <strong>ni testés ni maintenus par l\'équipe HumHub</strong>.<br><br>Ils peuvent ne pas être compatibles avec votre version de HumHub, entraîner <strong>une instabilité ou un comportement inattendu</strong>, et cesser de fonctionner après de futures mises à jour. Leur maintenance à long terme n\'est pas garantie.<br><br>N\'activez cette option que si vous comprenez les risques et faites confiance à la source du module que vous comptez installer.',
  'Configure' => 'Configurer',
  'Continue to checkout' => 'Passer au payement',
  ...
  'Deprecated' => 'Obsolète',
  'Description, Name, Keywords...' => 'Description, Nom, Mots-clés...',
  ...
  'Great!' => 'Très bien !',
  'I understand the risk and want to continue.' => 'Je comprends les risques et je souhaite continuer.',
  'If this Module is additionally marked as <strong>"Unverified Community"</strong> it is neither tested nor maintained by the HumHub project team. It may cause instability or stop working after future updates.' => 'Si ce module est également signalé comme <strong>« Communauté non vérifiée »</strong>, cela signifie qu\'il n\'est ni testé ni maintenu par l\'équipe du projet HumHub. Il peut entraîner une instabilité ou cesser de fonctionner après de futures mises à jour.',
  'Include community modules' => 'Inclure les modules communautaires',
  'Include unverified community modules?' => 'Inclure les modules communautaires non vérifiés ?',
  'Information' => 'Information',
  'Install' => 'Installer',
  'Install anyway' => 'Installer malgré tout',
  'Install unverified community module?' => 'Installer un module communautaire non vérifié ?',
  'Installed' => 'Installé',
  ...
  'Module options' => 'Options du module',
  ...
  'Unverified Community' => 'Communautée non vérifiée',
  ...
  'Yes, show community modules' => 'Oui, afficher les modules communautaires',
  'You are about to install <strong>{moduleName}</strong>, an unverified community module.<br><br>This module is provided by a third party and has not been reviewed or tested by the HumHub team. It may behave unexpectedly, conflict with other modules, or stop working with future HumHub releases.<br><br>Make sure you trust the source before continuing.' => 'Vous êtes sur le point d\'installer <strong>{moduleName}</strong>, un module communautaire non vérifié.<br><br>Ce module est fourni par un tiers et n\'a pas été examiné ni testé par l\'équipe HumHub. Il peut présenter un comportement inattendu, entrer en conflit avec d\'autres modules ou cesser de fonctionner avec les futures versions de HumHub.<br><br>Assurez-vous que la source est fiable avant de continuer.',
  'You are about to purchase <strong>{moduleName}</strong>, an unverified community module.<br><br>This module is provided by a third party and has not been reviewed or tested by the HumHub team. It may behave unexpectedly, conflict with other modules, or stop working with future HumHub releases.<br><br>Make sure you trust the source before continuing.' => 'Vous êtes sur le point d\'acheter <strong>{moduleName}</strong>, un module communautaire non vérifié.<br><br>Ce module est fourni par un tiers et n\'a pas été examiné ni testé par l\'équipe HumHub. Il peut présenter un comportement inattendu, entrer en conflit avec d\'autres modules ou cesser de fonctionner avec les futures versions de HumHub.<br><br>Assurez-vous que la source est fiable avant de continuer.',
