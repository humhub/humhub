...
' => 'Die Lizenz wurde erfolgreich entfernt!',
  ...
  'Buy unverified community module?' => 'Nicht verifiziertes Community-Modul kaufen?',
  'Cancel' => 'Abbrechen',
  'Categories' => 'Kategorien',
  'Changelog' => 'Änderungsprotokoll',
  'Community' => 'Community',
  'Community modules are developed by third parties and are <strong>not tested or maintained by the HumHub team</strong>.<br><br>They may not be compatible with your HumHub version, can cause <strong>instability or unexpected behavior</strong>, and may stop working after future updates. Their long-term maintenance is not guaranteed.<br><br>Only enable this option if you understand the risks and trust the source of the module you intend to install.' => 'Community-Module werden von Drittanbietern entwickelt und <strong>nicht vom HumHub-Team getestet oder gewartet</strong>.<br><br>Sie sind möglicherweise nicht mit deiner HumHub-Version kompatibel, können <strong>Instabilität oder unerwartetes Verhalten</strong> verursachen und nach zukünftigen Updates möglicherweise nicht mehr funktionieren. Eine langfristige Wartung ist nicht garantiert.<br><br>Aktiviere diese Option nur, wenn du die Risiken verstanden hast und der Quelle des Moduls vertraust, das du installieren möchtest.',
  ...
  'Great!' => 'Prima!',
  'I understand the risk and want to continue.' => 'Ich verstehe das Risiko und möchte fortfahren.',
  'If this Module is additionally marked as <strong>"Unverified Community"</strong> it is neither tested nor maintained by the HumHub project team. It may cause instability or stop working after future updates.' => 'Wenn dieses Modul zusätzlich als <strong>„Nicht verifiziertes Community-Modul“</strong> gekennzeichnet ist, wurde es weder vom HumHub-Projektteam getestet noch gewartet. Es kann Instabilität verursachen oder nach zukünftigen Updates nicht mehr funktionieren.',
  'Include community modules' => 'Community-Module einschließen',
  'Include unverified community modules?' => 'Nicht verifizierte Community-Module einschließen?',
  'Information' => 'Informationen',
  'Install' => 'Installieren',
  'Install anyway' => 'Trotzdem installieren',
  'Install unverified community module?' => 'Nicht verifiziertes Community-Modul installieren?',
  ...
  'Unverified Community' => 'Nicht verifizierte Community',
  ...
  'Yes, show community modules' => 'Ja, Community-Module anzeigen',
  'You are about to install <strong>{moduleName}</strong>, an unverified community module.<br><br>This module is provided by a third party and has not been reviewed or tested by the HumHub team. It may behave unexpectedly, conflict with other modules, or stop working with future HumHub releases.<br><br>Make sure you trust the source before continuing.' => 'Du bist dabei, <strong>{moduleName}</strong>, ein nicht verifiziertes Community-Modul, zu installieren.<br><br>Dieses Modul wird von einem Drittanbieter bereitgestellt und wurde vom HumHub-Team weder geprüft noch getestet. Es kann sich unerwartet verhalten, mit anderen Modulen in Konflikt stehen oder mit zukünftigen HumHub-Versionen nicht mehr funktionieren.<br><br>Stelle sicher, dass du der Quelle vertraust, bevor du fortfährst.',
  'You are about to purchase <strong>{moduleName}</strong>, an unverified community module.<br><br>This module is provided by a third party and has not been reviewed or tested by the HumHub team. It may behave unexpectedly, conflict with other modules, or stop working with future HumHub releases.<br><br>Make sure you trust the source before continuing.' => 'Du bist dabei, <strong>{moduleName}</strong>, ein nicht verifiziertes Community-Modul, zu kaufen.<br><br>Dieses Modul wird von einem Drittanbieter bereitgestellt und wurde vom HumHub-Team weder geprüft noch getestet. Es kann sich unerwartet verhalten, mit anderen Modulen in Konflikt stehen oder mit zukünftigen HumHub-Versionen nicht mehr funktionieren.<br><br>Stelle sicher, dass du der Quelle vertraust, bevor du fortfährst.',
