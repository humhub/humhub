...
return [
  ...
  'Expand' => 'Amplia',
  'Export' => 'Exporta:',
  'I\'m not a robot' => 'No sóc un robot',
  'Info:' => 'Informació',
  ...
  'Show all results' => 'Mostra tots els resultats',
  ...
  'Switch network' => 'Commutador de xarxa',
  ...
  'Verified' => 'Verificat',
  'We couldn\'t verify that you\'re human. Please check the box again.' => 'No hem pogut verificar que ets humà. Torna a marcar la casella.',
  ...
  '{attribute} has been empty. The system-configured function to fill empty values has returned an invalid value. Please try again or contact your administrator.' => 'L\'attribut {attribute} ha estat buit. La funció configurada pel sistema per omplir valors buits ha retornat un valor no vàlid. Torneu-ho a provar o poseu-vos en contacte amb l\'administrador.',
  '{attribute} must be a string (UUID) or null; {type} given.' => '{attribute} ha de ser una cadena (UUID) o nul; s\'ha indicat {type}.',
