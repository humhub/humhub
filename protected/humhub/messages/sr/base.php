...
return [
    '<strong>Confirm</strong> Action' => '<strong>Potvrdi</strong> акцију',
    '<strong>Latest</strong> updates' => '<strong>Novo</strong> објаве',
    '<strong>Mail</strong> summary' => '<strong>Mejl</strong> преглед',
    'Actions' => 'Akcije',
    'Add:' => 'Dodaj:',
    'Administration' => 'Administracija',
    'All' => 'Sve',
    'Allow' => 'Dozvoli',
    'Allow content from external source' => 'Dozvoli sadržaj sa spoljnih izvora',
    'Always allow content from this provider!' => 'Uvek dozvoli sadržaj ovog provajdera.',
