...
if ($linkOutput == 'button') { ?>
    ...
    <button class="<?= $class; ?> <?php if ($tooltip != "") : ?>tt<?php endif;?>" style="<?= $style; ?>" data-toggle="modal" data-target="#confirmModal_<?= $uniqueID; ?>" <?= $tooltip; ?>>
        <?= $linkContent; ?>
    </button>
...
<?php } else if ($linkOutput == 'a') { ?>
    ...
    <a id="deleteLinkPost_<?= $uniqueID; ?>" class="<?= $class; ?> <?php if ($tooltip != "") : ?>tt<?php endif;?>" style="<?= $style; ?>" href="#" data-toggle="modal" data-target="#confirmModal_<?= $uniqueID; ?>" <?= $tooltip; ?>>
       <?= $linkContent; ?>
    </a>
...
<!-- start: Confirm modal -->
<div class="modal" id="confirmModal_<?= $uniqueID; ?>" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true">
    <div class="modal-dialog modal-dialog-extra-small animated pulse">
        <div class="modal-content">
            ...
            <div class="modal-footer">
                ...
                <?php } ?>
                <?php if ($buttonFalse != "") { ?>
                    <button type="button" class="btn btn-primary" data-dismiss="modal"><?= $buttonFalse; ?></button>
                <?php } ?>
            </div>
        </div>
    </div>
