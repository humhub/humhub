...
<script <?= \humhub\helpers\Html::nonce() ?>>
    $(document).ready(function() {
        ...
        $editableContent.atwho({
            ...
            at: ":",
            insert_tpl: "<img data-emoji-name=';${name};' class='atwho-emoji' with='18' height='18' src='<?php echo Yii::getAlias('@web-resources/img/emoji/${name}.svg'); ?>' />",
            tpl: "<li class='atwho-emoji-entry' data-value=';${name};'><img with='18' height='18' src='<?php echo Yii::getAlias('@web-resources/img/emoji/${name}.svg'); ?>'/></li>",
            data: emojis_list,
