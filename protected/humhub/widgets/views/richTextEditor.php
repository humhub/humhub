...
<script>
    $(document).ready(function() {
        ...
        if(!$editableContent.length) {
            $formInput.after('<div id="<?= $id; ?>_contenteditable" autocomplete="off" class="atwho-input form-control atwho-placeholder" data-query="0" contenteditable="true">' + placeholder + '</div>');
        ...
        $editableContent.atwho({
            ...
            at: ":",
            insert_tpl: "<img data-emoji-name=';${name};' class='atwho-emoji' with='18' height='18' src='<?= Yii::getAlias('@web-static/img/emoji/${name}.svg'); ?>' />",
            tpl: "<li class='atwho-emoji-entry' data-value=';${name};'><img with='18' height='18' src='<?= Yii::getAlias('@web-static/img/emoji/${name}.svg'); ?>'/></li>",
            data: emojis_list,
