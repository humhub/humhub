...
class AccountRegister extends \yii\base\Model
{
    ...
    public function rules()
    {
        return array(
            [['email'], 'required'],
            [['email'], 'email'],
            [['email'], 'unique', 'targetClass' => \humhub\core\user\models\User::className(), 'message' => Yii::t('UserModule.forms_AccountRegisterForm', 'E-Mail is already in use! - Try forgot password.')],
        );
    }
