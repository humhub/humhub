...
class AccountController extends Controller
{
    ...
    public $subLayout = "@humhub/core/user/views/account/_layout";
    ...
    public function actionEditSettings()
    {
        ...
        $model = new \humhub\core\user\models\forms\AccountSettings();
    ...
    public function actionDelete()
    {
        ...
        $model = new \humhub\core\user\models\forms\AccountDelete;
    ...
    {
        $user = Yii::$app->user->getIdentity();
        $model = new \humhub\core\user\models\forms\AccountEmailing();
    ...
    public function actionChangeEmail()
    {
        ...
        $model = new \humhub\core\user\models\forms\AccountChangeEmail;
    ...
    public function actionChangeEmailValidate()
    {
        ...
        $emailAvailablyCheck = \humhub\core\user\models\User::findOne(['email' => $email]);
    ...
    public function actionChangePassword()
    {
        ...
        $userPassword = new \humhub\core\user\models\Password();
