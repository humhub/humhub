<li>
    ...
    echo HHtml::ajaxLink('<i class="fa fa-bell-slash-o"></i> '.Yii::t('ContentModule.widgets_views_notificationSwitchLink', 'Turn off notifications'), Yii::app()->createUrl('//wall/content/notificationSwitch', array(
                'id' => $content->id,
    ...
    ?>
    <?php
    echo HHtml::ajaxLink('<i class="fa fa-bell-o"></i> '.Yii::t('ContentModule.widgets_views_notificationSwitchLink', 'Turn on notifications'), Yii::app()->createUrl('//wall/content/notificationSwitch', array(
                'id' => $content->id,
                'className' => get_class($content),
                'switch' => 1
            )), array(
