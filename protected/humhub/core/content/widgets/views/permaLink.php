...
<li>
    ...
    echo humhub\widgets\ModalConfirm::widget(array(
        ...
        'message' => '<textarea rows="3" id="permalink-txt-' . $id . '" class="form-control permalink-txt">' . Url::to(['//wall/perma/content', 'model' => $model, 'id' => $id]) . '</textarea><p class="help-block">Copy to clipboard: Ctrl+C, Enter</p>',
