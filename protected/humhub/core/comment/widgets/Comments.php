...
class Comments extends \yii\base\Widget
{
    ...
    public function run()
    {
        ...
        // Count all Comments
        $commentCount = \humhub\core\comment\models\Comment::GetCommentCount($modelName, $modelId);
        $comments = \humhub\core\comment\models\Comment::GetCommentsLimited($modelName, $modelId, 2);
