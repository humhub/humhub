...
class ThemeHelper
{
    ...
    public static function getAllVariables(Theme $theme): array
    {
        ...
        $variables = ScssHelper::getVariables(Yii::getAlias('@webroot-resources/scss/variables.scss'));
    ...
    public static function buildCss(?Theme $theme = null, bool $includeCustomScss = true): bool|string
    {
        ...
        $compiler->addImportPath(Yii::getAlias('@webroot-resources/scss'));
