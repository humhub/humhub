...
$.fn.userpicker.addUserTag = function (guid, image_url, name, id) {
    ...
    if ($('#user_' + guid + ' a').attr('data-taken') != "true") {
        ...
        var _tagcode = '<li class="userInput" id="' + id + '_' + guid + '"><img class="rounded" data-src="holder.js/24x24" style="width: 24px; height: 24px;" src="' + image_url + '" alt="' + name + '" width="24" height="24" />' + name + '<i class="fa fa-times-circle"></i></li>';
