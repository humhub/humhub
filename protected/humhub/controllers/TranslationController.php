...
/**
 * Controller for translation API
 * Provides translations for frontend components
 */
class TranslationController extends Controller
{
    ...
    /**
     * Returns translations for the specified category or categories
     */
    public function actionIndex(string $category): Response
    {
