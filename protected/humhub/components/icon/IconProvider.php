 ...
 *
 * The [[render()]] function of a IconProvider should ideally support all features of the [[\humhub\widgets\Icon]]
 * widget and furthermore map all icon names available in [[\humhub\widgets\Icon::$names]].
 *
 * @since 1.4
 */
