                                ...
                                <table align="Right" border="0" cellpadding="0" cellspacing="0" width="480"
                                    ...
                                    <tbody><tr>
                                        <td valign="top" class="textContent">
                                            <strong><?php echo $creator->displayName; ?></strong> <?php echo Yii::t('NotificationModule.base', 'declined your membership for'); ?> <strong><?php echo Helpers::truncateText($notification->space->name, 25); ?></strong><br>
