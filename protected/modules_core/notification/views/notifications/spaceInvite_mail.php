                                ...
                                <table align="Right" border="0" cellpadding="0" cellspacing="0" width="480"
                                    ...
                                    <tbody><tr>
                                        <td valign="top" class="textContent">
                                            <strong><?php echo $creator->displayName; ?></strong> <?php echo Yii::t('NotificationModule.base', 'invited you to'); ?> <strong><?php echo Helpers::truncateText($notification->space->name, 25); ?></strong><br>
                                            <a href="<?php echo $notification->getUrl(); ?>" target="_blank"><?php echo Yii::t('NotificationModule.base', 'Join now'); ?></a>
                                        </td>
                                    </tr>
                                    </tbody>
                                </table>
