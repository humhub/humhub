<li class="<?php if (!$notification->seen) : ?>new<?php endif; ?>">
    <a href="<?php echo $notification->getUrl(); ?>">
        <div class="media">
            ...
            <div class="media-body">
                <strong><?php echo $sourceObject->displayName; ?></strong>
                <?php echo Yii::t('NotificationModule.base', ' declined your membership for'); ?>
                <strong><?php echo Helpers::trimText($notification->space->name, 35); ?></strong>
                <br><span class="time"
    ...
    <i class="icon-remove-sign approval declined"></i>
</li>
