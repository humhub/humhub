<div class="panel panel-default">
    <div class="panel-heading"><?php echo Yii::t('AdminModule.authentication', '<strong>Authentication</strong> - LDAP'); ?></div>
    <div class="panel-body">

        <ul class="nav nav-pills">
            <li>
                <a href="<?php echo $this->createUrl('authentication'); ?>"><?php echo Yii::t('AdminModule.authentication', 'Basic'); ?></a>
            </li>
            <li class="active"><a
                    href="<?php echo $this->createUrl('authenticationLdap'); ?>"><?php echo Yii::t('AdminModule.authentication', 'LDAP'); ?></a>
            </li>
        </ul>
        ...
        <?php if ($enabled): ?>
            <?php if ($errorMessage != ""): ?>
                <div
                    class="danger"><?php echo Yii::t('AdminModule.authentication', 'Status: Error! (Message: {message}', array('{message}' => $errorMessage)); ?></div>
            <?php else: ?>
                <div
                    class="success"><?php echo Yii::t('AdminModule.authentication', 'Status: OK! ({userCount} Users)', array('{userCount}' => $userCount)); ?></div>
            <?php endif; ?>
        <?php endif; ?>
