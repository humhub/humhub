<div class="panel panel-default">
    ...
    <div class="panel-body">
        ...
        <?php if ($prefix != ""): ?>
            <?php echo HHtml::postLink(Yii::t('AdminModule.views_setting_oembed_edit', 'Delete'), $this->createUrl('oembedDelete', array('prefix' => $prefix)), array('class' => 'btn btn-danger pull-right')); ?>
        <?php endif; ?>
        <?php $this->endWidget(); ?>
