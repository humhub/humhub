<div class="panel panel-default">
    ...
    <div class="panel-body">
        ...
        <div class="form-group">
            <?php echo $form->labelEx($model, 'defaultPostPolicy'); ?>
            <?php $postPolicies = array(0 => Yii::t('SpaceModule.base', 'Admin only'), 1 => Yii::t('SpaceModule.base', 'All members')); ?>
            <?php echo $form->dropDownList($model, 'defaultPostPolicy', $postPolicies, array('class' => 'form-control', 'id' => 'post_policy_dropdown', 'hint' => Yii::t('SpaceModule.views_admin_edit', 'Choose the kind of posting rights you want to provide for this workspace.'))); ?>
        </div>
