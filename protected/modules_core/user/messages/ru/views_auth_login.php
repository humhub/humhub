...
return array (
  ...
  'Create a new one.' => 'Создать новую',
  'Don\'t have an account? Join the network by entering your e-mail address.' => 'У вас нет аккаута? Присоеденитесь к сети с помощью email',
