...
<div>
<?php if ($this->wallEntryId != 0): ?>
    <a href="#" onClick="activityShowItem(<?php echo $this->wallEntryId; ?>);
        return false;">
<?php endif; ?>
    <div class="media">
        <!-- Show user image -->
        <img class="media-object img-rounded pull-left" data-src="holder.js/32x32" alt="32x32"
             ...
             src="<?php echo $activity->contentMeta->getUser()->getProfileImage()->getUrl(); ?>">

        <!-- Show space image, if you are outside from a space -->
        <?php if (Wall::$currentType != Wall::TYPE_SPACE && $activity->contentMeta->workspace != null): ?>
            <img class="media-object img-rounded img-space pull-left" data-src="holder.js/20x20" alt="20x20"
                 style="width: 20px; height: 20px;"
                 src="<?php echo $activity->contentMeta->workspace->getProfileImage()->getUrl(); ?>">
        <?php endif; ?>
        ...
        <div class="media-body">
            ...
            <!-- show time -->
            <?php echo HHtml::timeago($activity->contentMeta->created_at); ?>
        </div>
    </div>
<?php if ($this->wallEntryId != 0): ?>
    </a>
