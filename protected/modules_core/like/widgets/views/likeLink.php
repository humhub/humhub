...
<?php if (Yii::app()->user->isGuest): ?>
     <i class="likelinkicon"></i><?php echo CHtml::link(Yii::t('LikeModule.widgets_views_likeLink', 'Like'), Yii::app()->user->loginUrl, array('data-target' => '#globalModal', 'data-toggle' => 'modal')); ?>
<?php else: ?>
     <i class="likelinkicon"></i><a href="#" id="<?php echo $id . "-LikeLink"; ?>" class="like likeAnchor"
