                                ...
                                <table align="Right" border="0" cellpadding="0" cellspacing="0" width="480" class="flexibleContainer">
                                    <tbody><tr>
                                        <td valign="top" class="textContent">
                                            ...
                                            <strong><?php echo $creator->displayName; ?></strong> <?php echo Yii::t('TasksModule.base', 'assigned you to'); ?>  <?php echo $targetObject->getContentTitle(); ?><?php if ($workspace != null && Wall::$currentType != Wall::TYPE_SPACE): ?> in <strong><?php echo Helpers::truncateText($workspace->name, 25); ?></strong><?php endif; ?><br/>
                                            <br/>
