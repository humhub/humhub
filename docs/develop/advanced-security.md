...
- Obviously use [permissions](concept-permissions.md) to secure vulnerable sections of your module.
...
- Also see the [Administration Security Guide](advanced-security.md)
