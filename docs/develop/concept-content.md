...
> Info: For more information about permissions, please see the [Permission Section](concept-permissions.md).
...
See the [Use of ContentContainerModule](module-base-class.md#contentcontainermodule) section.

## Content Streams

See the [Stream](concept-stream.md) section
