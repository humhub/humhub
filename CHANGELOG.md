...
- Enh #8261: In the mobile app settings, change Whitelist domains to URLs, and add SSO URLs to the list for the mobile app to open all of them in the in-app browser instead of the external one
