...
1.20.0 (Unreleased)
-------------------
- Enh #PRNUM: Removed the unused `ContainerImageSet` widget together with its asset bundle, JavaScript and CSS — it was added in 2019 and never rendered by the core or any known module; first step of taking the `ui` module apart
