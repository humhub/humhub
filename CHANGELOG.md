...
-------------------------------
- Fix #8414: A grouped activity named the same user twice ("Sara Schuster and Sara Schuster joined the space") when that user had more than one activity in the group
