...
1.19.0-beta.2 (TBD)
-------------------
- Enh: Added the content module option `silentContentCreationTypes`, listing content record classes whose creation is never announced — no content created notification, no activity and no new content marker in the space chooser.
