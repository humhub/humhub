...
<link href="<?php echo Yii::app()->baseUrl; ?>/css/complement.css" rel="stylesheet">
<link href="<?php echo Yii::app()->theme->baseUrl; ?>/css/sample.css" rel="stylesheet">
...
<script type="text/javascript" src="<?php echo Yii::app()->theme->baseUrl; ?>/js/sample.js"></script>
