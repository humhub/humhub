    ...
    $('#search-menu-search').keyup(function (event) {
        if (event.keyCode == 40) {
            ...
            if (_searchString.length >= 3) {
                ...
                var _menuStructure = '<li class="dropdown-divider"></li><li><ul class="media-list"><li id="loader_search"><div class="loader"><div class="sk-spinner sk-spinner-three-bounce"><div class="sk-bounce1"></div><div class="sk-bounce2"></div><div class="sk-bounce3"></div></div></div></li></ul></li>';
