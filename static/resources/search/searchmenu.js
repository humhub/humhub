    ...
    $('#search-menu-search').keyup(function (event) {
        ...
        if (event.keyCode == 40) {
            ...
            if (_searchString.length >= 3) {
                ...
                var _menuStructure = '<li><hr class="dropdown-divider"></li><li><div class="dropdown-item media-list"><div id="loader_search"><div class="loader"><div class="sk-spinner sk-spinner-three-bounce"><div class="sk-bounce1"></div><div class="sk-bounce2"></div><div class="sk-bounce3"></div></div></div></div></div></li>';
